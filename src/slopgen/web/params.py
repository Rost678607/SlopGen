...
def common(b: dict) -> dict:
    ...
    out: dict = {
        ...
        "write_metadata": bool(b.get("write_metadata", False)),
...
def fandom_params(store: ConfigStore, b: dict) -> RunParams:
    ...
    params = RunParams(
        ...
        fandom_invent=b.get("fandom_invent", "no"),
...
_FIELDS: list[dict] = [
    ...
    {"f": "fandom_voice", "kind": "select", "l": "web.f.narrator", "opts": "voices",
     "modes": ["fandom"]},
    {"f": "fandom_invent", "kind": "select", "l": "web.f.invent",
     "opts": "invent_levels", "opt_l": "inv.", "modes": ["fandom"]},
    ...
    {"f": "push", "kind": "select", "l": "web.f.publish", "opts": "accounts",
     "blank": True},
    {"f": "write_metadata", "kind": "check", "l": "web.f.meta"},
