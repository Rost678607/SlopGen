...
def info(
    ...
    metadata: bool = typer.Option(False, "--metadata", help="write a title, a description and tags for the finished video; off by default, and turned on for you whenever the run actually publishes"),
    ...
    try:
        params = store.resolve(
            ...
            clean_subtitles=clean_subs, write_metadata=metadata,
