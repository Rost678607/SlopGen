...
def fandom(
    ...
    viewer_role: str = typer.Option("", "--viewer-role", help="usher only: who the 'you' is, in the world's own words ('a clerk with a desk and a third-form pass'). Empty = taken from the world's fandom.toml, or worked out from its records"),
